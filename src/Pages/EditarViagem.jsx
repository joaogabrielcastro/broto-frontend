...
const EditarViagem = () => {
  ...
  const carregarMotoristas = () => {
    axios
      .get(`${API_BASE_URL}/motoristas`)
      .then((res) => setMotoristas(res.data))
      .catch((error) => {
        console.error("Erro ao buscar motoristas:", error);
        setErro((prev) =>
          prev
            ? prev + " Erro ao carregar motoristas."
  ...
  const carregarClientes = () => {
    axios
      ...
      .catch((error) => {
        ...
        setErro((prev) =>
          prev
            ? prev + " Erro ao carregar clientes."
  ...
  const handleEditar = (viagemSelecionada) => {
    setEdicao({
      ...viagemSelecionada,
      inicio: viagemSelecionada.inicio
        ? dayjs(viagemSelecionada.inicio).format("YYYY-MM-DD")
        : "",
      fim: viagemSelecionada.fim
        ? dayjs(viagemSelecionada.fim).format("YYYY-MM-DD")
        : "",
  ...
  const confirmarFinalizar = async () => {
    ...
    try {
      await axios.patch(
        `${API_BASE_URL}/viagens/${modalFinalizar.id}/finalizar`,
        { custos: modalFinalizar.custos }
      );
            ...
            {viagens.length > 0 ? (
              <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                {viagens.map((v) => (
                  <div
                    key={v.id}
                    className="bg-neutral-700 border border-red-600 p-4 rounded-lg shadow-md text-gray-100 flex flex-col md:flex-row md:items-center md:justify-between"
                  >
                    <div>
                      <p className="mb-1">
                        <strong className="text-red-400">Placa:</strong>{" "}
                        {v.placa}
                      </p>
                      <p className="mb-1">
                      ...
                      <p className="mb-1">
                        <strong className="text-red-400">Rota:</strong>{" "}
                        {v.origem || "N/A"}{" "}
                        <span className="text-red-400 font-bold">➔</span>{" "}
                        {v.destino || "N/A"}
                      </p>
                      <p className="mb-1">
                        <strong className="text-red-400">Início:</strong>{" "}
                        {v.inicio
                          ? dayjs(v.inicio).format("DD/MM/YYYY")
                          : "N/A"}
                      </p>
                      <p className="mb-1">
                        <strong className="text-red-400">Fim:</strong>{" "}
                        {v.fim ? dayjs(v.fim).format("DD/MM/YYYY") : "N/A"}
                      </p>
                      <p className="mb-1">
                      ...
                      <p className="mb-1">
                        <strong className="text-red-400">Lucro Total:</strong>{" "}
                        R$ {parseFloat(v.lucro_total || 0).toFixed(2)}
                      </p>
                      <p>
          ...
          <div className="mt-8 p-8 bg-neutral-800 rounded-lg shadow-2xl border border-red-700 text-gray-100">
            <div className="mb-4">
              ...
              <input
                ...
                value={edicao.placa}
                onChange={(e) =>
                  setEdicao({ ...edicao, placa: e.target.value })
                }
                disabled
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setEdicao({ ...edicao, caminhao_nome: e.target.value })
                }
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={(e) =>
                  setEdicao({ ...edicao, motorista_id: e.target.value })
                }
                className="w-full p-3 border border-red-700 rounded-md bg-neutral-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-300"
                required
              >
              ...
              {motoristas.length === 0 && (
                <p className="text-sm text-yellow-500 mt-2">
                  Nenhum motorista disponível. Cadastre motoristas primeiro.
                </p>
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={(e) =>
                  setEdicao({ ...edicao, cliente_id: e.target.value })
                }
                className="w-full p-3 border border-red-700 rounded-md bg-neutral-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-300"
                required
              >
              ...
              {clientes.length === 0 && (
                <p className="text-sm text-yellow-500 mt-2">
                  Nenhum cliente disponível. Cadastre clientes primeiro.
                </p>
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={edicao.inicio}
                onChange={(e) =>
                  setEdicao({ ...edicao, inicio: e.target.value })
                }
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={edicao.origem}
                onChange={(e) =>
                  setEdicao({ ...edicao, origem: e.target.value })
                }
                required
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setEdicao({ ...edicao, destino: e.target.value })
                }
                required
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={edicao.frete}
                onChange={(e) =>
                  setEdicao({ ...edicao, frete: e.target.value })
                }
              />
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={edicao.custos}
                onChange={(e) =>
                  setEdicao({ ...edicao, custos: e.target.value })
                }
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={
                  parseFloat(edicao.frete || 0) - parseFloat(edicao.custos || 0)
                } // Calcula na UI
                disabled
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <select
                ...
                value={edicao.status}
                onChange={(e) =>
                  setEdicao({ ...edicao, status: e.target.value })
                }
              >
        ...
        {modalFinalizar.aberto && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <div className="bg-neutral-800 p-8 rounded-lg shadow-2xl border border-red-700 max-w-sm w-full text-gray-100">
              ...
              <p className="mb-2">
                Insira os custos para calcular o lucro total:
              </p>
              <div className="mb-4">
                <label
                  htmlFor="custos-finalizar"
                  className="block text-gray-200 text-sm font-semibold mb-2"
                >
                  Custos (R$):
                </label>
              ...
              <p className="mb-6">
                Frete: R$ {parseFloat(modalFinalizar.frete || 0).toFixed(2)} -
                Custos: R$ {parseFloat(modalFinalizar.custos || 0).toFixed(2)} =
                Lucro: R${" "}
                {(
                  parseFloat(modalFinalizar.frete || 0) -
                  parseFloat(modalFinalizar.custos || 0)
                ).toFixed(2)}
              </p>
              <div className="flex justify-end gap-4">
                <button
