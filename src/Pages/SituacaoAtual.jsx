...
const SituacaoAtual = () => {
  ...
  const carregarViagens = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const validViagens = rawData.filter(
          (v) => v && v.placa && v.inicio && v.status
        );
      ...
      .catch((err) => {
        ...
        setErro(
          "Erro ao carregar a situação atual. Tente novamente mais tarde."
        );
        setViagens([]);
      })
      .finally(() => {
  ...
  const handlePassarParaCustos = (viagemId) => {
    ...
    setViagens((prevViagens) =>
      prevViagens.filter((v) => String(v.viagem_id) !== String(viagemId))
    );
                  ...
                  return (
                    ...
                    >
                      <div className="mb-4 md:mb-0">
                        ...
                        <p className="mb-1">
                          <strong>
                            <span className="text-red-400">Nome Caminhão:</span>
                          </strong>{" "}
                          {v.caminhao_nome || "N/A"}
                        </p>
                        <p className="mb-1">
                          <strong>
                            <span className="text-red-400">Motorista:</span>
                          </strong>{" "}
                        ...
                        <p className="mb-1">
                          <strong>
                            <span className="text-red-400">Cliente:</span>
                          </strong>{" "}
